namespace JaneERP
{
    /// <summary>Reads and displays the application log files from the JaneERP log folder.</summary>
    internal class FormLogViewer : Form
    {
        ...
        private void BuildUI()
        {
            ...
            // ── Header strip ────────────────────────────────────────────────────
            var pnlTop = new Panel { Dock = DockStyle.Top, Height = 44, BackColor = Theme.Header, Padding = new Padding(8, 8, 8, 0) };
        ...
        private void Refresh_Click(object? sender, EventArgs? e)
        {
            ...
            try
            {
                ...
                // Read with shared access so the log file can still be written while we read
